  ...
  <body>
    <nav>
        ...
        <br><br><br><br><br>
            ...
            <h1 class="text-center ">Orientadores Registrados</h1><br>
                                        <?php
                                        $con=mysqli_connect("localhost","id5798215_rojo","12523916","id5798215_proesco") or die("error de conexion");
                                        $maes=mysqli_query($con,"select * from usuario where Rol_Id=2")or die("problemas en el query".mysqli_error($con));
                                        echo"<center>";
                                        echo"<table >";
                                            echo"<tr>";
                                                echo"<b>";
                            ...
                            <form method="post" action="phpborrarD.php">
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="id" class="form-control" placeholder="Escribe la ID" /><br><br>

...
<body>
<!--https://ugc.kn3.net/i/origin/http://de.acidcow.com/pics/20110819/acid_picdump_21.jpg-->
	<nav>
        <div class="block33">
          <div class="menu">
            ...
            <div class="idioma"><a href="inicioA.html" style="color: #00783E;text-decoration: none;">P-E</a></div>
          </div>
        </div>
        <div class="block33">
          <a href="index.html"><div class="logo text-center"><img src="https://lh3.googleusercontent.com/-UxnuGd21SSQ/W8_VqHurpvI/AAAAAAAAAH0/XJy9nhll0RYn84qhFq3Pfgomr2hZcyBGgCJoC/w530-h636-n-rw/ProEsco.png" height='80px' width='100px'></div></a>
        </div>
        <div class="block33">
          <div class="donar">
          ...
          <div class="donar">
            <a href="opcion.html">REGISTRARSE</a>
        </div>
        </div>
        <div class="clear"></div>
      </nav>
...
<?php 
	...
	$consulta=mysqli_query($con,"select * from usuario where Id_Usu='$id'")or die("problemas en la consulta".mysqli_error($con));
	if($reg=mysqli_fetch_array($consulta)){
?>
<center>

    <div class="container">
	<form action="phpactuD.php" method="post">
	    <label>ID</label><br>
	    <input type="text" name="id" class="form-control" readonly value="<?php echo $reg['Id_Usu'] ?>"><br>
	    <label>Nombre</label><br>
	    <input type="text" name="nombre" class="form-control" value="<?php echo $reg['Nom_Usu'] ?>"><br>
	    <label>Apellido Paterno</label><br>
	    <input type="text" name="apa" class="form-control" value="<?php echo $reg['Ape_pat'] ?>"><br>
	    <label>Apellido Materno</label><br>
	    <input type="text" name="ama" class="form-control" value="<?php echo $reg['Ape_Mat'] ?>"><br>
	    
	    <label>Correo electronico</label><br>
	    <input type="email" name="email" class="form-control" value="<?php echo $reg['Correo_Usu'] ?>"><br>
	    
	    <label>Contraseña</label><br>
	    <input type="text" name="contra" class="form-control"  value="<?php echo $reg['Contra_Usu'] ?>"><br>
	    <button class="subnit">Modificar</button><br><br>
	</form>
	</div>
	<form action="phperaseD.php" method="get" >
	    <input type="hidden" name="id" readonly value="<?php echo $reg['Id_Usu'] ?>"><br>
	    
	    <button class="submit">Borrar</button>
	...
	<div class="row">
    	<div class="col-sm-12">
            <div class="donar">
                <a href="phpCataD.php">REGRESAR</a>
            </div>
